  ...
  return (
    <div className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Leadership Team - Founder and Director in Same Row */}
        <motion.div
        ...
        >
          ...
          >
            <Card className="bg-white/80 backdrop-blur-sm shadow-2xl border-none hover:scale-105 transition-all duration-300">
          ...
          {organizationData.directors.map((director, index) => (
            ...
            >
              <Card className="bg-white/80 backdrop-blur-sm shadow-xl border-none hover:scale-105 transition-all duration-300">
                <CardContent className="p-8 text-center">
                  <div className={`w-24 h-24 rounded-full bg-gradient-to-br ${director.color} flex items-center justify-center mx-auto mb-6 text-white text-2xl font-bold shadow-lg`}>
                    {director.avatar}
                  </div>
                  <h3 className="text-2xl font-bold text-gray-800 mb-2">{director.name}</h3>
