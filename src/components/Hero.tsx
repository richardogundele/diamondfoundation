...
const Hero = () => {
  return (
    <div className="relative bg-gradient-to-b from-accent1 to-white pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-lg md:text-xl text-textSecondary mb-8 max-w-3xl mx-auto animate-fade-in">
            Empowering underprivileged children in Africa with education,
            healthcare, and spiritual guidance to build brighter futures.
          </p>
