        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col items-center justify-center">
            <div className="max-w-4xl w-full mb-8">
              <img 
                src={megaOutreachImage} 
                alt="Mega Outreach 2024 - Grand Visit to 6 Orphanage Homes in 6 Months" 
                className="w-full h-auto rounded-lg shadow-lg"
              />
            </div>
            
            <div className="bg-blue-50 p-8 rounded-lg shadow-lg max-w-4xl w-full">
              <h3 className="text-2xl font-bold text-textPrimary mb-4">Mega Outreach 2024</h3>
